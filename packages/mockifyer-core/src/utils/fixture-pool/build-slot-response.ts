  ...
  if (assignment.kind === 'response') {
    ...
    return {
      mockData: {
        ...
        responseFieldOverrides: fieldOverrides.length ? fieldOverrides : undefined,
        responseDateOverrides: dateOverrides.length ? dateOverrides : undefined,
      },
  ...
  if (assignment.kind === 'entity') {
    ...
    return {
      mockData: {
        ...
        timestamp: now,
        responseFieldOverrides: context.slotOverrides?.responseFieldOverrides,
        responseDateOverrides: context.slotOverrides?.responseDateOverrides,
      },
