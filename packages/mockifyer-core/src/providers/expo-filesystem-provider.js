...
exports.ExpoFileSystemProvider = void 0;
 ...
 */
class ExpoFileSystemProvider {
    constructor(config) {
        var _a, _b, _c;
        this.fileCache = new Map(); // Key: requestKey
        this.fileModTimes = new Map(); // Key: filename, Value: mtime
        this.watchInterval = null;
        this.watchEnabled = false;
        this.watchIntervalMs = 2000; // Check every 2 seconds
        ...
        if (((_a = config.options) === null || _a === void 0 ? void 0 : _a.watchFiles) !== false) {
            this.watchEnabled = true;
            this.watchIntervalMs = ((_b = config.options) === null || _b === void 0 ? void 0 : _b.watchInterval) || 2000;
            this.onFilesChanged = (_c = config.options) === null || _c === void 0 ? void 0 : _c.onFilesChanged;
        }
        ...
        try {
            ...
            throw new Error('expo-file-system is required for ExpoFileSystemProvider. Install it with: npx expo install expo-file-system');
        }
    }
    /**
            ...
            if (typeof fetch !== 'undefined') {
                ...
                if (response.ok) {
                    ...
                    if (data.success && data.currentScenario) {
                        ...
                        await this.FileSystem.writeAsStringAsync(configPath, JSON.stringify(config, null, 2));
     ...
     */
    async ensureScenarioFolder(scenario) {
    ...
    async save(mockData) {
        ...
        if (MAX_REQUESTS_PER_SCENARIO !== undefined) {
            try {
                ...
                const jsonFiles = files.filter((file) => file.endsWith('.json') && file !== 'scenario-config.json' && file !== 'date-config.json');
        ...
        // Write to file (async)
        try {
            await this.FileSystem.writeAsStringAsync(filePath, JSON.stringify(mockData, null, 2));
    ...
    async findExactMatch(request, requestKey) {
        ...
        for (const file of files) {
            try {
                ...
                const requestUrl = ((_a = mockData.request) === null || _a === void 0 ? void 0 : _a.url) || '';
                if (requestUrl.includes('/mockifyer-save') ||
                    requestUrl.includes('/mockifyer-clear') ||
                    requestUrl.includes('/mockifyer-sync')) {
                    continue;
        ...
        if (matches.length > 0) {
            ...
            const responseData = (_c = (_b = bestMatch.mockData) === null || _b === void 0 ? void 0 : _b.response) === null || _c === void 0 ? void 0 : _c.data;
...
exports.ExpoFileSystemProvider = ExpoFileSystemProvider;
