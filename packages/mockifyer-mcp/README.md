...
| `mockifyer_list_override_groups` | List groups + default/lane/effective selection |
| `mockifyer_set_active_override_group` | Set lane or scenario-default active group |
