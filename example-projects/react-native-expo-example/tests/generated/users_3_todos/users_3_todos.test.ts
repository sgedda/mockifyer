/**
 * Auto-generated test file for GET /users/3/todos
 * 
...
describe('/users/3/todos', () => {
   ...
   */
  it('should GET /users/3/todos', async () => {
    const response = await fetch('https://jsonplaceholder.typicode.com/users/3/todos?_limit=5');
