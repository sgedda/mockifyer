/**
 * Auto-generated test file for GET /users/2/todos
 * 
...
describe('/users/2/todos', () => {
   ...
   */
  it('should GET /users/2/todos', async () => {
    const response = await fetch('https://jsonplaceholder.typicode.com/users/2/todos?_limit=5');
